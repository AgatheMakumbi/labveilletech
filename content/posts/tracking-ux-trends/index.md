...
@media (min-width: 1025px) {
  .single-post img[src$="ux-trends-cover.webp"],
  .single-post img[src$="google_favourites_system.png"],
  .single-post img[src$="uxmindmap.webp"] {
    width: 70%;
    max-width: 70%;
    margin-left: auto;
    margin-right: auto;
...
![Folders by category](google_favourites_system.png)
